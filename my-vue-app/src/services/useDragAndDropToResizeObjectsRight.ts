...
function useDragAndDropToResizeObjectsRight({ ref, size, setSize, slideId, objId, scale, setSelectedObjects, isResizing, setIsResizing }: DragAndDropProps) {
...
export { useDragAndDropToResizeObjectsRight }