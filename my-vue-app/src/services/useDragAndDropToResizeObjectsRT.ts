...
function useDragAndDropToResizeObjectsRT({ ref, size, setSize, slideId, objId, scale, setSelectedObjects, isResizing, setIsResizing }: DragAndDropProps) {
...
export { useDragAndDropToResizeObjectsRT }
