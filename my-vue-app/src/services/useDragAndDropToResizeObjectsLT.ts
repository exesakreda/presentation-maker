...
function useDragAndDropToResizeObjectsLT({ ref, size, setSize, slideId, objId, scale, setSelectedObjects, isResizing, setIsResizing }: DragAndDropProps) {
...
export { useDragAndDropToResizeObjectsLT }
